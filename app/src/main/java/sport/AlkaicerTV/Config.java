...
public class Config {
    ...
    public static final String API_SERVER_URL = "https://uiap.teamalkaicer.com/api/";

    //copy your api key from php admin dashboard & paste below
    public static final String API_KEY = "yad79o74qr68im2g2glppk5b";

    //copy your terms url from php admin dashboard & paste below
    public static final String TERMS_URL = "https://uiap.teamalkaicer.com/terms";
